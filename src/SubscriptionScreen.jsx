...
const TIERS = [
  ...
  },
  {
    ...
    name: "Fleet Starter",
    priceGHS: 99,
    tagline: "For small fleets — up to 5 vehicles",
    perks: [
      "Basic fleet dashboard",
      "Vehicle management",
      "Charging history & costs",
      "Station availability",
      "Basic route planning",
      "Basic battery/range info",
    ],
  },
  {
    id: "fleet_business",
    name: "Fleet Business",
    priceGHS: 249,
    tagline: "For growing fleets — up to 15 vehicles",
    highlight: true,
    perks: [
      "Everything in Starter",
      "Driver management & assignment",
      "Battery/range monitoring",
      "Charger reservations & schedules",
  ...
  },
  {
    ...
    name: "Fleet Pro",
    priceGHS: 499,
    tagline: "For larger fleets — up to 30 vehicles",
    perks: [
      "Everything in Business",
      "Automated charging schedules",
      "AI route optimization",
      "AI Fleet Assistant",
      "Predictive battery/range insights",
      "Multiple fleet managers",
      "Priority support",
    ],
  },
  {
    ...
    priceGHS: null,
    custom: true,
    tagline: "For fleets larger than 30 vehicles",
    perks: [
      "Custom vehicle limits",
      "Multiple fleet locations & managers",
      "API integrations",
      "Custom reporting",
      "Corporate billing",
      "Dedicated support",
